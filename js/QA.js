document.addEventListener('DOMContentLoaded', function() {
    ...
    faqItems.forEach(item => {
        ...
        answer.style.maxHeight = "0px"; // Asegura que la respuesta esté oculta
        answer.style.overflow = "hidden"; // Evita que el contenido sobresalga
        answer.style.transition = "max-height 0.3s ease-out"; // Añade transición suave
    ...
    faqItems.forEach(item => {
        ...
        question.addEventListener('click', () => {
            ...
            faqItems.forEach(faqItem => {
                ...
                answer.style.maxHeight = "0px"; // Cierra respuestas
            ...
            if (!isActive) {
                ...
                const answer = item.querySelector('.faq-answer');
                answer.style.maxHeight = answer.scrollHeight + "px"; // Abre la respuesta
                const arrowIcon = item.querySelector('.arrow-icon');
